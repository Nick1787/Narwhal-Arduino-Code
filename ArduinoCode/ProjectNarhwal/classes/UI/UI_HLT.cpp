...
namespace UI_HLT{
	...
	EZUI *UI  = new EZUI();
		...
		***************************************/
		...
		//Page Items
		EZUI_Control_Label Lbl_Status(pTXT_Hlt,&HLT_Controller().Status);
		EZUI_Control_ToggleOption Tgl_Sol1Val(pTXT_Sol1,HLT_Controller().GasValve_Low);
		EZUI_Control_ToggleOption Tgl_Sol2Val(pTXT_Sol2,HLT_Controller().GasValve_High);
		EZUI_Control_Label Lbl_BPVal(pTXT_BP,&HLT_RTD_BP.degF);
		EZUI_Control_Label Lbl_OPVal(pTXT_OP,&HLT_RTD_OP.degF);
		...
		***************************************/
		...
		EZUI_Control_Label Lbl_RTDs_HLT_BP_Vo(pTXT_Vo,&HLT_RTD_BP.Vo);
		EZUI_Control_Label Lbl_RTDs_HLT_BP_Vs(pTXT_Vs,&HLT_RTD_BP.Vs);
		EZUI_Control_Label Lbl_RTDs_HLT_BP_Rcalc(pTXT_Rcalc,&HLT_RTD_BP.Rcalc);
		EZUI_Control_Label Lbl_RTDs_HLT_BP_degC(pTXT_degC,&HLT_RTD_BP.degC);
		EZUI_Control_Label Lbl_RTDs_HLT_BP_degF(pTXT_degF,&HLT_RTD_BP.degF);

		EZUI_PageItems Page_RTDs_BP_Items[] = {
			{  0,  0, 11, &Lbl_RTDs_HLT_BP_Rcalc},
			{  12,  0, 7, &Lbl_RTDs_HLT_BP_Vo},
			{  1,  1, 11, &Lbl_RTDs_HLT_BP_degC},
			{  12,  1, 7, &Lbl_RTDs_HLT_BP_Vs},
			{  1,  2, 11, &Lbl_RTDs_HLT_BP_degF},
		...
		***************************************/
		...
		EZUI_Control_Label Lbl_RTDs_HLT_OP_Vo(pTXT_Vo,&HLT_RTD_OP.Vo);
		EZUI_Control_Label Lbl_RTDs_HLT_OP_Vs(pTXT_Vs,&HLT_RTD_OP.Vs);
		EZUI_Control_Label Lbl_RTDs_HLT_OP_Rcalc(pTXT_Rcalc,&HLT_RTD_OP.Rcalc);
		EZUI_Control_Label Lbl_RTDs_HLT_OP_degC(pTXT_degC,&HLT_RTD_OP.degC);
		EZUI_Control_Label Lbl_RTDs_HLT_OP_degF(pTXT_degF,&HLT_RTD_OP.degF);

		EZUI_PageItems Page_RTDs_OP_Items[] = {
			{  0,  0, 11, &Lbl_RTDs_HLT_OP_Rcalc},
			{  12,  0, 7, &Lbl_RTDs_HLT_OP_Vo},
			{  1,  1, 11, &Lbl_RTDs_HLT_OP_degC},
			{  12,  1, 7, &Lbl_RTDs_HLT_OP_Vs},
			{  1,  2, 11, &Lbl_RTDs_HLT_OP_degF},
			{  0,  3, 4, &Lnk_Page_BackDiag}
		};
		...
		***************************************/
		EZUI_Control_ListOption Lst_FBProbe(pTXT_PRB, &HLT_Controller().FeedbackProbe);
		EZUI_Control_AdjustParam Lst_Dmd(pTXT_DMD, HLT_Controller().SetTemp);
		EZUI_Control_Label Lbl_FBK(pTXT_FBK,&HLT_Controller().FeedbackTemp);
		EZUI_Control_Label LBL_Sol1(pTXT_Sol1,HLT_Controller().GasValve_Low);
		EZUI_Control_Label LBL_Sol2(pTXT_Sol2,HLT_Controller().GasValve_High);
		...
		***************************************/
		...
		EZUI_Control_AdjustParam Adj_LowOffset(pTXT_LowOffset, HLT_Controller().LowOffset);
		...
		***************************************/
		...
		/***************************************
		 Main Diagnostics
		***************************************/
		EZUI_Control_Label Lbl_PilotStatus(pTXT_Pilot,&HLT_TC_ON,pTXT_On_NoColon,pTXT_Off_NoColon);
		EZUI_Control_Label Lbl_PilotVoltage(pTXT_V,&HLT_TC_V);
		EZUI_Control_Label Lbl_BPTemp(&HLT_RTD_BP.degF);
		EZUI_Control_Label Lbl_OPTemp(&HLT_RTD_OP.degF);
