...
{
	static BurnerController* ans = new BurnerController(&HLT_TC_ON, &HLT_RTD_BP, &HLT_RTD_OP, HLT_SOL1, HLT_SOL2, &HLT_SetTemp, &HLT_HighErrHys, &HLT_HighErrLim, &HLT_OffErrHys, &HLT_OffErrLim);
	return *ans;
}
...
{
	static BurnerController* ans = new BurnerController(&MLT_TC_ON, &MLT_RTD_BP, &MLT_RTD_OP, MLT_SOL1, MLT_SOL2, &MLT_SetTemp, &MLT_HighErrHys, &MLT_HighErrLim, &MLT_OffErrHys, &MLT_OffErrLim);
	return *ans;
}
...
{
	static BurnerController* ans = new BurnerController(&BK_TC_ON, &BK_RTD_BP, &BK_RTD_OP, BK_SOL1, BK_SOL2, &BK_SetTemp, &BK_HighErrHys, &BK_HighErrLim, &BK_OffErrHys, &BK_OffErrLim);
	return *ans;
}